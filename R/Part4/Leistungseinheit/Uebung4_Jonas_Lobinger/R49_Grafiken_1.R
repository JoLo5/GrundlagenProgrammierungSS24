...
# t1_start
plot(x=airquality$Temp, y=airquality$Ozone, pch=16, col="#FFA50080", 
     las=1, xlim=c(50,100), main="Mehr Ozon an warmen Tagen", 
     cex=c(airquality$Wind/5), ylab="\U00D8 Ozon  [ppb]",
...
# t5_start
legend("topleft", levels(leg_wind), pch=16, col="orange",
       title="Windgeschwindigkeit  [mph]", pt.cex=leg_wind/5, legend=leg_wind)
