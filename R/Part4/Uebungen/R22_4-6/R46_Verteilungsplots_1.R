...
meta <- read.csv("R46d_Meta.csv", na.strings = c("-1111.1", "-2222", "-2222.2"))
gesundheit <- read.csv("R46d_Gesundheit.csv", na.strings = c("-1111.1", "-2222", "-2222.2"))
...
# t2_start
boxplot(gesundheit$Smoker, horizontal = TRUE, range = 0, ylim = c(0, 70))
...
# t5_start
hist(gesundheit$Obesity, breaks = 30, col = "plum", main = "CHSI Fettleibigkeit", 
     xlab = "", las = 1)
# t5_ende
